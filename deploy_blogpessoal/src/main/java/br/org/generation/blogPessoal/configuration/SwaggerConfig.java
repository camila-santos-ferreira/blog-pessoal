...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/camila-santos-ferreira").contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Camila Ferreira", "https://github.com/camila-santos-ferreira",
				"camilaferreira68@hotmail.com");
	}
